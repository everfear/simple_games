...
def getSecretNum():
    # Returns line of random numbers, length of the line is NUM_DIGITS
...
def getClues(guess, secretNum):
    # Returns line with tip to the player "Hot", "Very hot" and "Cold"
    if guess == secretNum:
        return 'Вы угадали!!'
...
def isOnlyDigits(num):
    # Returns True only if num - line only with digits, otherwise its False
    if num == '':
        return False
