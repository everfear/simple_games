...
окунь олень орел осел панда паук питон попугай пума семга скунс собака сова \
тигр тритон тюлень утка форель хорек черепаха ястреб ящерица'.split()
...
def playAgain():
    ...
    print('Хотите сыргать еще? (да или нет)')
    ...
    if guess in secretWord:
        ...
        if len(missedLetters) == len(HANGMAN_PICS) - 1:
            ...
            print('Вы исчерпали все попытки!\nНе угадано букв: ' + str(len(missedLetters)) +
                  ' и угадано букв: ' + str(len(correctLetters)) +
